...
public class TextCandidates1LineViewManager extends CandidatesViewManager {
   ...
   /** {@code Handler} Handler for focus Candidate wait delay */
    ...
    public View initView(OpenWnn parent, int width, int height) {
        ...
        mLeftMoreButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!v.isShown()) {
                    return;
                }
        ...
        mLeftMoreButton.setOnLongClickListener(new OnLongClickListener() {
            public boolean onLongClick(View v) {
                if (!v.isShown()) {
                    return false;
                }
        ...
        mRightMoreButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!v.isShown()) {
                    return;
                }
        ...
        mRightMoreButton.setOnLongClickListener(new OnLongClickListener() {
            public boolean onLongClick(View v) {
                if (!v.isShown()) {
                    return false;
                }

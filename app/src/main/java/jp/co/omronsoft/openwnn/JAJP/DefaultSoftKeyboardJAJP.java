...
public class DefaultSoftKeyboardJAJP extends DefaultSoftKeyboard {
    ...
    private final String TAG = DefaultSoftKeyboardJAJP.class.getSimpleName();

    /**
     * Default constructor
     */
    public DefaultSoftKeyboardJAJP() {
        Log.d(TAG, "DefaultSoftKeyboardJAJP");
    ...
    /**
     * @see DefaultSoftKeyboard#createKeyboards
     */
    @Override
    protected void createKeyboards(OpenWnn parent) {
        Log.d(TAG, "createKeyboards");
    ...
    /**
     * @see DefaultSoftKeyboard#initView
     */
    @Override
    ...
    /**
     * @see DefaultSoftKeyboard#changeKeyboard
     */
    @Override
    protected boolean changeKeyboard(Keyboard keyboard) {
        Log.d(TAG, "changeKeyboard");
        if (keyboard != null) {
    ...
    /**
     * @see DefaultSoftKeyboard#changeKeyboardType
     */
    @Override
    public void changeKeyboardType(int type) {
        Log.d(TAG, "changeKeyboardType: " + type);
        commitText();
        ...
        switch (primaryCode) {
            ...
            case KEYCODE_JP12_SHARP:
                ...
                if (mInputType == INPUT_TYPE_INSTANT) {
                    ...
                    Log.d(TAG, "mInputType: INPUT_TYPE_INSTANT");
                } else {
            ...
            case KEYCODE_JP12_SPACE:
                Log.d(TAG, "KEYCODE_JP12_SPACE");
                // 2023-03-31 Gino modify
...
//                }
    ...
    /**
     * @see DefaultSoftKeyboard#setPreferences
     */
    @Override
    ...
    /**
     * @see DefaultSoftKeyboard#onUpdateState
     */
    @Override
    ...
    private void createKeyboardsPortrait(OpenWnn parent) {
        Log.d(TAG, "createKeyboardsPortrait");
        Keyboard[][] keyList;
        if (OpenWnn.isXLarge()) {
    ...
    private void createKeyboardsLandscape(OpenWnn parent) {
        Log.d(TAG, "createKeyboardsLandscape");
        Keyboard[][] keyList;
        if (OpenWnn.isXLarge()) {
    ...
    private int getTableIndex(int keyCode) {
        Log.d(TAG, "getTableIndex: " + keyCode);
        int index =
    ...
    private void setShiftByEditorInfo() {
        Log.d(TAG, "setShiftByEditorInfo");
    ...
    /**
     * @see DefaultSoftKeyboard#setHardKeyboardHidden
     */
    @Override
    public void setHardKeyboardHidden(boolean hidden) {
        Log.d(TAG, "setHardKeyboardHidden: " + hidden);
        if (mWnn != null) {
            if (!hidden) {
    ...
    /**
     * @see DefaultSoftKeyboard#setHardware12Keyboard
     */
    @Override
    public void setHardware12Keyboard(boolean type12Key) {
        Log.d(TAG, "setHardware12Keyboard: " + type12Key);
        if (mWnn != null) {
    ...
    private int filterKeyMode(int keyMode) {
        Log.d(TAG, "filterKeyMode: " + keyMode);
    ...
    public boolean showInputModeSwitchDialog() {
        Log.d(TAG, "showInputModeSwitchDialog");

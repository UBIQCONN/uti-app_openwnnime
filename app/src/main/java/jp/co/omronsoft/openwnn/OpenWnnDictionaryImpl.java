...
public class OpenWnnDictionaryImpl implements WnnDictionary {
    ...
    private final String TAG = OpenWnnDictionaryImpl.class.getSimpleName();
    ...
    public OpenWnnDictionaryImpl(String dicLibPath, String dicFilePath) {
        Log.d(TAG, "OpenWnnDictionaryImpl: dicLibPath - " + dicLibPath + ", dicFilePath - " + dicFilePath);
    ...
    protected void createDictionaryTable(String tableName) {
        Log.d(TAG, "createDictionaryTable: " + tableName);
